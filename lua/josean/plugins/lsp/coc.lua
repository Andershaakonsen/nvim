...
prize = {
  ...
  -- Use <c-y> to confirm completion and advance.
  -- Use <c-u> to close completion menu and advance.
  -- Use <c-d> to close completion menu and insert a newline.
  -- Use <c-f> and <c-b> to scroll in popup menu.
  -- Use <c-n> and <c-p> to select item in completion menu.
